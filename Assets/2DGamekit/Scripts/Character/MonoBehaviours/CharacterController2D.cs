...
*/          m_CurrentPosition =transform.position;
        ...
        void FixedUpdate()
        {
            ...
            transform.Translate(m_NextMovement);
        ...
        public void CheckCapsuleEndCollisions(bool bottom = true)
        {
            ...
            if (m_Capsule == null)
            {
                ...
                raycastStart = raycastStart + Vector2.up;
            ...
            if (bottom)
            {
                ...
                else
                {
                    ...
                    if (m_Capsule != null)
                    {
                        ...
                        {
                            float capsuleBottomHeight = transform.position.y + m_Capsule.offset.y - m_Capsule.size.y * 0.5f;
